...
#u = unsigned integer forced to positive numbers only
#i = (signed) integer able to accept positive and negative numbers
...
plt.title('Resale Transactions by Flat Type based on Registered Cases from 2006 to 2018')
